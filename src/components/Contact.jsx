    ...
    <section className="contact" id="contact">
      ...
      <div className="contact-container">
        ...
        <div className="contact-social">
          ...
          <ul>
            <li>
              <a href="https://linkedin.com/in/md-rafi-dudekula/" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <a href="https://github.com/Mr-Brown-Rafi" target="_blank" rel="noopener noreferrer">
                <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
